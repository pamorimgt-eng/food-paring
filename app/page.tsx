...
const ACESSOS = [
  {
    href: "/sala",
    titulo: "Sala",
    descricao: "Registar pedidos por mesa e sugerir vinho ao cliente.",
  },
  {
    href: "/cozinha",
    titulo: "Cozinha",
    descricao: "Ecrã de pedidos em tempo real.",
  },
  {
    href: "/backoffice",
    titulo: "Backoffice",
    descricao: "Carregar o menu e a carta de vinhos, ver relatórios.",
  },
];
