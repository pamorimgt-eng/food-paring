...
/**
 * Ponto de entrada da aplicação operacional (distinto da home de marketing
 * em app/page.tsx). Sem ecrã intermédio: quem já tem sessão vai direto para
 * a sua área, quem não tem vai para o login.
 *
